...
pointLight2.position.set(-1.86,1,-0.79)
...
const pointLight3 = new THREE.PointLight(0x35a5d4, 2)
pointLight3.position.set(1.46, -1, -0.79)
...
const updateSphare= (event) => {
    sphere.position.y=window.scrollY*0.004
}

window.addEventListener('scroll', updateSphare);
